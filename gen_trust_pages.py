...
about_body = """
      ...
      <div class="callout">
        We are not a lead-generation business. We don't capture your phone number or email, and we don't sell shopper information. No one holds a paid relationship that affects a ranking — <strong>you can't buy your way up, and best rates come first.</strong> That rule doesn't change, whatever we do to keep the lights on.
      </div>

      <h2><span class="num">§ 01</span>What BoringRate is</h2>

      <p>Most rate-comparison sites are lead funnels wearing an editorial costume — the ranking exists to route your contact information to three to five buyers who then call you. BoringRate is the opposite arrangement. There is no form that sends your details anywhere. The rankings and rate-change trackers are the product, and they are built to be <strong>read and checked</strong>, not to harvest a lead.</p>
      ...
      <p>BoringRate doesn't make money today. That may change one day — but only in ways that stay aligned with your interest. The hard line: <strong>you cannot buy your way up the rankings.</strong> No insurer or agency can pay for placement or a better position, and best rates always come first. That is not for sale, ever.</p>

      <p>If we do monetize, it will be through something that adds real value for you — for example, paid ad placement for independent agents who genuinely provide comparison value. What will never happen is a carrier, agent, or anyone else paying to change where they rank.</p>

      <p><strong>We also don't sell your information, because we never collect it.</strong> There is no email or phone capture on this site to sell.</p>

      <h2><span class="num">§ 03</span>Where our numbers come from</h2>
      ...
      <h2><span class="num">§ 04</span>Editorial independence</h2>
      ...
      <h2><span class="num">§ 06</span>Corrections &amp; contact</h2>
