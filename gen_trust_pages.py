...
# ─────────────────────────────────────────────────────────── ABOUT ──
about_body = """
      <p>BoringRate is an independent research project that tracks what U.S. auto, home, and renters insurers are actually charging — and, increasingly, who is raising and cutting rates — using the carriers' own approved rate filings. It exists for one reader in particular: the person who just opened a renewal notice, saw a number that made no sense, and wants to know whether it's them, their carrier, or the whole market.</p>

      <div class="callout">
        We are not a lead-generation business. We do not capture your phone number or email, we do not sell shopper information, and we hold <strong>no commissioned relationships with any carrier</strong> we rank. That is the whole business model: publish honest research, carry no inventory.
      </div>
...
ed_body = """
      ...
      <p>No carrier, agency, or lead buyer pays for placement, and none can influence a ranking. BoringRate holds no commissioned relationships with any carrier it lists and captures no shopper information to sell. A carrier that cuts rates is marked as a cutter and a carrier that raises them is marked as a raiser, regardless of size, relationship, or how the result reads.</p>
