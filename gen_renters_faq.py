...
"does-renters-insurance-cover": dict(
 ...
 sections=[
  ("Water damage","<p><strong>Sometimes.</strong> Sudden, accidental water from inside — a burst pipe, an overflowing appliance, a leak from the unit above — is covered. <strong>Flood</strong> (rising water from outside) is <em>not</em> — that needs a separate flood policy. Sewer/drain backup is often excluded unless you add an endorsement. The apartment&rsquo;s <a class=\"ca-link\" href=\"/renters/does-renters-insurance-cover-carpet-damage.html\">carpet is the landlord&rsquo;s property</a>, not yours to claim. <a class=\"ca-link\" href=\"/renters/does-renters-insurance-cover-water-damage.html\">Full guide: does renters insurance cover water damage? &rarr;</a></p>"),
  ("Theft","<p><strong>Yes</strong> — theft of your belongings is covered, including off-premises (your car, a hotel, the gym) and break-ins. You'll pay your deductible, and high-value categories like jewelry may be capped unless scheduled. <a class=\"ca-link\" href=\"/renters/does-renters-insurance-cover-theft.html\">Full guide: burglary, robbery &amp; stolen belongings &rarr;</a></p>"),
  ...
  ("A car break-in","<p><strong>Split.</strong> Items stolen <em>from</em> your car (a laptop, headphones) are covered by your <strong>renters</strong> policy. Damage to the car itself or theft of the car is your <strong>auto</strong> comprehensive coverage, not renters. <a class=\"ca-link\" href=\"/renters/does-renters-insurance-cover-theft-from-car.html\">Full guide: theft from your car &rarr;</a></p>"),
...
"does-renters-insurance-cover-carpet-damage": dict(
 title="Does Renters Insurance Cover Carpet Damage? Usually Not Yours to Claim (2026)",
 h1="Does renters insurance cover carpet damage? Usually not — because the carpet isn&rsquo;t yours.",
 dek="Wall-to-wall carpet in a rental belongs to the landlord, so it isn&rsquo;t your property to claim. What your policy can do is pay the landlord when you accidentally ruin it — and that is a different part of the policy than most renters expect.",
 kicker="Renters Basics",
 read="5",
 lead="<p>This question gets answered badly almost everywhere, because it has two answers depending on one fact: <strong>who owns the carpet</strong>. Wall-to-wall carpet that came with the apartment is the landlord&rsquo;s property, so it is not covered by your personal property coverage &mdash; no matter who damaged it. An area rug you bought is yours, and is covered like any other belonging. And if <em>you</em> accidentally destroy the landlord&rsquo;s carpet, the part of your policy that may pay is <strong>liability</strong>, not personal property. Here is the whole thing, in order.</p>",
 sections=[
  ("The short answer","<p><strong>Your renters policy does not replace the apartment&rsquo;s carpet for you.</strong> Wall-to-wall carpet is part of the building &mdash; the landlord&rsquo;s insurance covers it, not yours. Two things your policy <em>can</em> do: it covers <strong>rugs and carpet you own</strong> as personal property when a covered peril damages them, and it may pay the <strong>landlord</strong> under your personal liability coverage if you accidentally cause certain kinds of damage to their carpet. What it never covers is stains, pet damage, and wear &mdash; the three reasons renters actually lose a deposit.</p>"),
  ("Who owns the carpet decides everything","<p>Sort your situation into one of these before anything else:</p><ul><li><strong>Wall-to-wall carpet installed in the unit</strong> &mdash; the landlord&rsquo;s property. Not covered by your personal property coverage, ever. If a covered event destroys it, the landlord claims on their own policy.</li><li><strong>An area rug you bought</strong> &mdash; your property, covered under personal property (Coverage C) for the same perils as your furniture: fire, theft, vandalism, sudden water discharge, windstorm.</li><li><strong>Carpet you paid to install yourself</strong> &mdash; usually treated as your property, but confirm with your insurer, because once it is affixed to the unit some policies treat it as the building&rsquo;s.</li></ul>"),
  ("When your policy pays the landlord instead","<p>This is the part most renters do not know about. Standard renters liability excludes damage to property in your care, custody and control &mdash; which is what a rented apartment is. But most policies carve out an exception for <strong>damage to the rented premises caused by fire, smoke, explosion, or water</strong>. So:</p><ul><li><strong>Your bathtub overflows and ruins the carpet</strong> &mdash; your personal liability (Coverage E) may pay the landlord for the carpet, because water damage to the premises is the classic carve-out.</li><li><strong>A kitchen fire scorches the carpet</strong> &mdash; same. This is liability, not your personal property coverage.</li><li><strong>You drag a couch and tear it</strong> &mdash; not a covered peril. That is a security-deposit conversation.</li></ul><p>Note what this means practically: you do not file a claim to get <em>your</em> carpet replaced. The landlord comes to you for the cost, and your liability coverage is what responds.</p>"),
  ("Carpet damage that is never covered","<p>These are the denials, and they cover most real cases:</p><ul><li><strong>Pet damage</strong> &mdash; chewing, clawing, and above all urine. Excluded as both non-sudden and as damage to property in your care. This is the single most common carpet loss and the single most reliably uncovered one.</li><li><strong>Stains and spills</strong> &mdash; wine, coffee, ink, dye from a rug pad. Not a covered peril, and almost always below your deductible anyway.</li><li><strong>Wear and tear, matting, traffic patterns</strong> &mdash; the definition of maintenance. In most states a landlord cannot charge you for normal wear either, so check your local rules before paying.</li><li><strong>Gradual water damage</strong> &mdash; a slow leak you could have caught. Sudden is covered; slow is maintenance.</li><li><strong>Mold in the carpet</strong> &mdash; usually excluded or tightly capped, especially when it followed a gradual leak.</li><li><strong>Burns, cuts, and tears</strong> &mdash; a dropped iron, a cigarette, moving furniture. Sudden, yes, but not a covered peril.</li></ul>"),
  ("What to do when the landlord bills you","<p>Carpet is the most-disputed deposit deduction there is, so handle it in this order:</p><ol><li><strong>Ask for the age of the carpet.</strong> Carpet depreciates &mdash; most guidance treats useful life as roughly 5 to 10 years. A landlord generally cannot charge you full replacement cost for a carpet that was already eight years old; they can charge for the remaining useful life.</li><li><strong>Separate damage from wear.</strong> Traffic patterns, flattening, and fading are wear, which is normally not chargeable to you.</li><li><strong>Get the move-in photos out.</strong> Dated photos are the entire argument.</li><li><strong>If the cause was sudden water or fire, notify your insurer</strong> &mdash; that is the liability carve-out above, and it may cover the bill.</li><li><strong>Ask for an itemised invoice</strong> rather than a flat deduction.</li></ol>"),
  ("Make sure the rest is actually covered","<p>The carpet itself is usually the landlord&rsquo;s problem, but everything standing on it is yours. Two settings decide whether that goes well: <strong>replacement cost</strong> coverage, so a ruined rug or sofa is paid at what a new one costs rather than its depreciated value, and a <strong>liability limit</strong> high enough to absorb a water or fire claim from the unit &mdash; the same coverage that responds when you damage the premises. The <a class=\"ca-link\" href=\"/renters/coverage.html\">coverage calculator</a> flags both. For the water side specifically, see the <a class=\"ca-link\" href=\"/renters/does-renters-insurance-cover-water-damage.html\">renters water damage guide</a>.</p>"),
 ],
 callout="<strong>Bottom line:</strong> the apartment&rsquo;s carpet is the landlord&rsquo;s property, so your policy will not replace it for you. Rugs you own are covered like any belonging, and your liability coverage may pay the landlord if you cause sudden water or fire damage. Pet damage, stains, and wear are never covered.",
 faq=[
  ("Does renters insurance cover carpet damage?","Usually not for you, because wall-to-wall carpet in a rental belongs to the landlord rather than to you. Rugs and carpet you own are covered as personal property against covered perils. If you accidentally cause sudden water or fire damage to the landlord's carpet, your personal liability coverage may pay them for it."),
  ("Does renters insurance cover pet damage to carpet?","No. Pet damage — chewing, clawing and urine — is excluded, both because it is not a sudden covered peril and because liability generally excludes damage to property in your care, custody and control. Pet carpet damage is normally a security-deposit matter."),
  ("Does renters insurance cover carpet stains?","No. Stains and spills are not a covered peril, and the cost is almost always below the deductible in any case. Normal wear such as traffic patterns and flattening is also not chargeable to you by the landlord in most states."),
  ("Who pays if I flood the apartment and ruin the carpet?","Your personal liability coverage may. Renters liability usually excludes property in your care and custody, but most policies carve out an exception for damage to the rented premises caused by fire, smoke, explosion or water — which is exactly this situation. Notify your insurer rather than paying the landlord directly."),
  ("Can my landlord charge me the full price of new carpet?","Generally no. Carpet depreciates, with a useful life commonly treated as five to ten years, so a landlord can usually charge only for the remaining useful life rather than full replacement. Ask for the carpet's age and an itemised invoice, and check your state's rules on normal wear and tear."),
  ("Does renters insurance cover a rug I own?","Yes. A rug you bought is personal property like any other belonging, covered against the policy's perils — fire, theft, vandalism, windstorm and sudden accidental water discharge. Replacement-cost coverage pays what a new one costs instead of the depreciated value."),
 ],
 cross=("/renters/does-renters-insurance-cover-water-damage.html","Renters water damage guide")),

"does-renters-insurance-cover-theft": dict(
 title="Does Renters Insurance Cover Theft? Burglary, Robbery &amp; Stolen Belongings (2026)",
 h1="Does renters insurance cover theft? Yes — burglary, robbery, and off-premises too.",
 dek="Theft of your belongings is covered whether someone breaks into your apartment, mugs you on the street, or steals from your car. Here's exactly what's covered, the limits that surprise people, and what to do after a theft.",
 kicker="Renters Basics",
 read="6",
 lead="<p>Theft is the scenario renters insurance handles most cleanly: <strong>if your belongings are stolen, they're covered — on or off your property</strong>, minus your deductible. The label doesn't matter (burglary, robbery, larceny, a mugging, a smash-and-grab), and neither does where it happened. The details worth knowing are the <em>limits</em> — your deductible and the category caps on things like jewelry — and how to file so the claim actually pays.</p>",
 sections=[
  ("The short answer","<p><strong>Yes.</strong> Personal property coverage (Coverage C) pays to replace belongings stolen from your home <em>and</em> away from it. You'll pay your <strong>deductible</strong>, high-value categories may be <strong>capped</strong> unless you've scheduled them, and you'll want a <strong>police report</strong>. That's the whole shape of it — everything below is detail.</p>"),
  ("Burglary, robbery, theft — the words don't change your coverage","<p>People search these separately, but renters insurance treats them the same:</p><ul><li><strong>Burglary</strong> — someone breaks into your home and takes your things. Covered.</li><li><strong>Robbery</strong> — property taken from you by force or threat (a mugging). Covered, including off your property.</li><li><strong>Theft / larceny</strong> — anything taken without permission, from a swiped package to a stolen bike. Covered.</li></ul><p>What matters to the insurer isn't the legal label — it's that your property was <em>stolen</em> (not lost or misplaced) and that you can document it.</p>"),
  ("What's covered, and where","<p>Coverage follows your property, not just your address:</p><ul><li><strong>A break-in at your apartment</strong> — electronics, furniture, clothes, appliances.</li><li><strong>Off-premises theft</strong> — a laptop stolen from your car, a phone lifted at a bar, gear taken from a hotel room or the gym, a bike cut from a rack.</li><li><strong>While traveling</strong> — belongings stolen on a trip are covered anywhere in the world.</li><li><strong>Package theft</strong> — porch piracy of a delivered package is generally covered (subject to your deductible, which often makes small packages not worth claiming).</li></ul><p>Note the split for cars: items stolen <em>from</em> your car are covered by <strong>renters</strong>; the car itself, or damage to it, is your <strong>auto</strong> comprehensive coverage. <a class=\"ca-link\" href=\"/renters/does-renters-insurance-cover-theft-from-car.html\">Full guide: does renters insurance cover theft from your car? &rarr;</a></p>"),
  ("The limits that trip people up","<p>Two things quietly shrink theft payouts:</p><p><strong>Your deductible.</strong> A $600 phone with a $500 deductible nets you $100 — and a claim can nudge your renewal premium. For small thefts it's often not worth filing.</p><p><strong>Category sublimits.</strong> Standard policies cap certain categories no matter your overall limit — typically <strong>jewelry, watches, and furs</strong> around $1,000–$2,500 <em>for theft</em>, <strong>firearms</strong> $2,000–$2,500, and <strong>cash</strong> as low as $200. If a stolen ring or camera kit is worth more than the cap, you only collect the cap — unless you <strong>scheduled</strong> it (an appraised add-on, usually with no deductible). If you own anything valuable, schedule it <em>before</em> it's stolen.</p>"),
  ("What theft is NOT covered","<p>The common denials:</p><ul><li><strong>Your roommate's belongings</strong> — a standard policy covers only the named policyholder (and usually family). Roommates need their own.</li><li><strong>Theft you can't document</strong> — no police report, no proof of ownership. \"It disappeared\" is not the same as \"it was stolen.\"</li><li><strong>Mysterious disappearance</strong> — items you simply lost or misplaced aren't theft.</li><li><strong>The car itself</strong> — auto comprehensive, not renters.</li><li><strong>Value above your category sublimits</strong> — see above; schedule high-value items.</li><li><strong>Business inventory or stock</strong> kept at home usually needs a separate rider.</li></ul>"),
  ("What to do after a theft","<ol><li><strong>Call the police and get a report number.</strong> Insurers require it for theft claims, and it deters fraud disputes.</li><li><strong>Inventory what was taken</strong> with proof — photos, receipts, serial numbers, or even old social-media pictures showing the item.</li><li><strong>Notify your insurer promptly</strong> and give them the police report number.</li><li><strong>Don't overstate.</strong> Claim what you can support; padding a claim is fraud and gets it denied.</li><li><strong>Check whether it clears your deductible</strong> before filing a small one — sometimes it's cheaper to absorb it than to log a claim.</li></ol>"),
  ("Make sure you're actually covered","<p>Three settings decide what a theft claim pays: <strong>replacement cost</strong> (so you're paid to re-buy, not the depreciated value), a <strong>deductible</strong> you can live with, and <strong>scheduled endorsements</strong> on anything above the category caps. The <a class=\"ca-link\" href=\"/renters/coverage.html\">coverage calculator</a> flags all three, and it's worth confirming renters insurance is even the right call for you — spoiler: <a class=\"ca-link\" href=\"/renters/is-renters-insurance-worth-it.html\">it almost always is</a>.</p>"),
 ],
 callout="<strong>Bottom line:</strong> theft is covered on and off your property, whatever you call it — but your deductible and category sublimits decide what you actually collect. Pick replacement-cost coverage and schedule anything valuable, and keep a police report for every claim.",
 faq=[
  ("Does renters insurance cover theft?","Yes. Personal property coverage replaces belongings stolen from your home or away from it — a car break-in, a hotel, the gym — subject to your deductible. High-value categories like jewelry may be capped unless scheduled."),
  ("Does renters insurance cover burglary?","Yes. A break-in and the theft of your belongings is a covered loss. You'll pay your deductible and should file a police report; value above category sublimits (jewelry, firearms, cash) is limited unless you've scheduled those items."),
  ("Does renters insurance cover robbery or mugging?","Yes. Property taken from you by force or threat is covered, including away from home. Keep a police report and document what was taken."),
  ("Does renters insurance cover items stolen from my car?","Yes — belongings stolen from your car (a laptop, headphones) are covered by your renters policy. The car itself and damage to it fall under auto comprehensive coverage, not renters."),
  ("Does renters insurance cover stolen packages?","Generally yes — porch-pirate theft of a delivered package is covered, subject to your deductible. Because the deductible often exceeds a small package's value, it may not be worth filing."),
  ("Do I need a police report to claim theft on renters insurance?","In practice, yes. Insurers require a police report number for theft claims, and it supports your claim if the loss is questioned."),
 ],
 cross=("/renters/what-does-renters-insurance-cover.html","What renters insurance covers")),

"does-renters-insurance-cover-theft-from-car": dict(
 title="Does Renters Insurance Cover Theft From Your Car? (2026)",
 h1="Does renters insurance cover theft from your car? Your stuff, yes — the car, no.",
 dek="Personal belongings stolen from your car — a laptop, headphones, a bag — are covered by your renters policy, not your auto policy. The car itself and its parts are auto comprehensive. Here's exactly where the line falls after a break-in.",
 kicker="Renters Basics",
 read="5",
 lead="<p>It surprises almost everyone: when someone smashes your car window and grabs the laptop off the seat, the <em>laptop</em> is a <strong>renters</strong> insurance claim, not an auto one — even though it was stolen from your car. Auto insurance covers the car; renters insurance covers the stuff you own, wherever it happens to be. Below is exactly who pays for what after a car break-in, why one break-in can mean two claims and two deductibles, and when it's even worth filing.</p>",
 sections=[
  ("The short answer","<p><strong>Yes — belongings stolen from your car are covered by your renters insurance</strong>, under personal property (Coverage C), because that coverage follows your property away from home. You'll pay your <strong>deductible</strong>, high-value categories may be <strong>capped</strong>, and you'll want a <strong>police report</strong>. What renters does <em>not</em> touch is the <strong>car itself</strong> — a broken window, a stolen stereo, damage to the door — that's your <strong>auto comprehensive</strong> coverage. Everything below is just detail on that split.</p>"),
  ("Renters vs. auto: who pays for what","<p>The line is simple once you see it — <strong>renters covers what's <em>in</em> the car; auto covers the car.</strong></p><p><strong>Your renters policy covers</strong> the personal items taken: a laptop, tablet, or phone, headphones, a backpack or purse, clothing, sports gear, tools, textbooks, gifts, a camera. If you owned it and it was portable, it's personal property — covered off-premises anywhere, including your car.</p><p><strong>Your auto policy (comprehensive) covers</strong> the vehicle and anything that's part of it: the <strong>broken window or glass</strong>, a pried door or ignition, the <strong>factory stereo and permanently installed equipment</strong>, catalytic converters, tires and wheels, and the car itself if it's stolen. Comprehensive is the same coverage that pays for theft of the whole vehicle.</p>"),
  ("What a car break-in actually looks like on a claim","<p>Take the classic smash-and-grab: a thief breaks the passenger window and takes your work laptop. That's <strong>two separate claims</strong>:</p><ul><li>The <strong>window</strong> → your <strong>auto comprehensive</strong> (subject to your auto deductible, often waived or reduced for glass).</li><li>The <strong>laptop</strong> → your <strong>renters</strong> policy (subject to your renters deductible).</li></ul><p>You file each with the right insurer. Neither policy covers the other's half, and there's no double-dipping — the laptop is a renters claim only, the glass is an auto claim only.</p>"),
  ("The deductible math — why many car break-ins aren't worth claiming","<p>This is where most people decide <em>not</em> to file. If your renters deductible is <strong>$500</strong> and a thief took a <strong>$650</strong> pair of headphones, you net $150 — and a claim can nudge your renewal premium at your next term. For a single low-value item, it's often cheaper to absorb the loss than to log a claim. It starts to make sense when the total stolen clearly exceeds your deductible (a laptop plus a camera plus a bag), or when several items were taken at once. Check the numbers before you file.</p>"),
  ("Sublimits and proof","<p>Two things shrink a payout. First, <strong>category sublimits</strong>: electronics are usually fine, but <strong>cash</strong> is capped low (often ~$200), and jewelry, watches, and high-end gear may be limited unless you've <strong>scheduled</strong> them. Second, <strong>documentation</strong>: insurers want a <strong>police report number</strong> plus proof you owned the item — a receipt, a photo, a serial number. \"There was a bag on the seat\" is harder to pay than a documented laptop.</p>"),
  ("What is NOT covered","<ul><li><strong>The car and its parts</strong> — window, glass, stereo, wheels, the vehicle itself. That's auto comprehensive.</li><li><strong>A friend's or roommate's belongings</strong> — renters covers only the named policyholder (and usually family). Their stuff is on their policy.</li><li><strong>Cash above the sublimit</strong> — the small cash cap applies wherever it's taken.</li><li><strong>Mysterious disappearance</strong> — items you can't show were <em>stolen</em> (no forced entry, no report) are often denied.</li><li><strong>Business inventory or stock</strong> kept in the car usually needs a separate rider.</li></ul>"),
  ("What to do after a car break-in","<ol><li><strong>Call the police and get a report number.</strong> Both your renters and auto insurers will ask for it.</li><li><strong>Photograph everything</strong> — the damage to the car and the space where your items were — and list what was taken with any proof of ownership.</li><li><strong>Split the claim correctly</strong> — the car/glass to your auto insurer, the stolen belongings to your renters insurer.</li><li><strong>Do the deductible math first</strong> on the renters side — decide whether the stolen items clear your deductible before filing.</li><li><strong>Don't overstate.</strong> Claim what you can document; padding a claim gets it denied.</li></ol>"),
  ("Make sure you're actually covered","<p>Three settings decide what a car-break-in claim pays on the renters side: <strong>replacement cost</strong> (so you're paid to re-buy, not the depreciated value), a <strong>deductible</strong> you can live with, and <strong>scheduled endorsements</strong> on anything above the category caps. The <a class=\"ca-link\" href=\"/renters/coverage.html\">coverage calculator</a> flags all three — and if you're weighing whether renters insurance is worth it at all, <a class=\"ca-link\" href=\"/renters/is-renters-insurance-worth-it.html\">it almost always is</a>. For the full picture on stolen property, see the <a class=\"ca-link\" href=\"/renters/does-renters-insurance-cover-theft.html\">renters theft &amp; burglary guide</a>.</p>"),
 ],
 callout="<strong>Bottom line:</strong> the stuff stolen <em>from</em> your car is a renters claim; the car, its glass, and its parts are an auto claim. One break-in can mean two deductibles — so do the math before you file, keep a police report, and carry replacement-cost coverage.",
 faq=[
  ("Does renters insurance cover theft from my car?","Yes. Personal belongings stolen from your car — a laptop, phone, headphones, a bag — are covered by your renters policy's personal property coverage, which follows your property off-premises. You pay your deductible, and a police report is required."),
  ("Does renters insurance cover a car break-in?","It covers the belongings taken in the break-in, not the car. The stolen items (laptop, gear, clothes) are a renters claim; the broken window, damaged door, or stolen stereo are an auto comprehensive claim. One break-in can produce two separate claims."),
  ("Is my laptop covered if it's stolen from my car?","Yes — a laptop stolen from your car is covered by renters insurance, subject to your deductible and (for high-value electronics) any category limits. Keep the receipt or serial number and file a police report."),
  ("Do I file a car break-in with renters or auto insurance?","Both, for different parts. File the stolen personal belongings with your renters insurer and the damage to the car — broken glass, the stereo, the door — with your auto insurer under comprehensive coverage."),
  ("Does renters insurance cover a broken car window?","No. Damage to the car itself, including a broken window from a break-in, is covered by your auto comprehensive coverage, not renters. Renters only covers the belongings taken from inside."),
  ("Is theft from a car worth claiming on renters insurance?","Only if the stolen items clearly exceed your deductible. A single low-value item often nets little after the deductible and can raise your renewal, so many small car-break-in losses aren't worth filing."),
 ],
 cross=("/renters/does-renters-insurance-cover-theft.html","Renters theft &amp; burglary guide")),
