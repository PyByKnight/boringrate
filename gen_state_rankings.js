...
<form onsubmit="event.preventDefault();var z=(this.zc.value||'').replace(/\\D/g,'').slice(0,5);if(/^\\d{5}$/.test(z)){location.href='/?zip='+z}else{this.zc.focus()}" style="display:flex;gap:0;max-width:360px;margin:16px 0;">
...
<p style="font-size:14px;color:var(--ink-soft);max-width:660px;margin:6px 0 4px;">Not sure how much coverage you need? <a class="ca-link" href="/coverage.html">Use the free Coverage Calculator &rarr;</a></p>
