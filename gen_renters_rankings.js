...
<form onsubmit="event.preventDefault();var z=(this.zc.value||'').replace(/\\D/g,'').slice(0,5);if(/^\\d{5}$/.test(z)){location.href='/renters/?zip='+z}else{this.zc.focus()}" style="display:flex;gap:0;max-width:360px;margin:16px 0;">
