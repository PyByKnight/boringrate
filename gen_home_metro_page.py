...
<body>'''
  ...
  <div class="article-body">
    ...
    <p style="font-size:13px;color:var(--ink-mute);max-width:660px;margin-top:14px;">Directional estimates from <a class="ca-link" href="/rate-filings/?state={st}&amp;product=Home">public rate filings</a> and NAIC data &mdash; not a quote. Metro figures apply a modeled {esc(name)} offset to the {esc(st_name)} average, which is anchored to those approved filings; your actual rate depends on dwelling amount, deductible, roof age, claims history, and exact ZIP.</p>
  </div>
</div>'''
    return head + "\n" + NAV + "\n" + body + "\n" + TAIL
